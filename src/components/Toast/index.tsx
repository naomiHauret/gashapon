...
const Toast = (props) => {
  ...
  return (
    <div {...api().rootProps} class={`overflow-hidden ${layerStyles}`}>
      ...
      <button
        class="absolute text-white text-opacity-50 hover:text-opacity-75 focus:text-opacity-90 rounded-full text-2xs top-0.5 inline-end-0.5 flex justify-center items-center p-0.5 bg-white bg-opacity-0 hover:bg-opacity-5 focus:bg-opacity-10"
