...
export const NESTED_ROUTE_DASHBOARD_GAME_OVERVIEW_GAME_PASS = '/game-pass'
...
export const ROUTE_DASHBOARD_GAME_OVERVIEW_GAME_PASS = `${ROUTE_DASHBOARD_GAME_OVERVIEW}/game-pass`
export const ROUTE_DASHBOARD_GAME_OVERVIEW_POST_GAME_PASS = `${ROUTE_DASHBOARD_GAME_OVERVIEW_GAME_PASS}/new`

export const ROUTE_DASHBOARD_GAME_OVERVIEW_FILES = `${ROUTE_DASHBOARD_GAME_OVERVIEW}/files`
export const ROUTE_DASHBOARD_GAME_OVERVIEW_POST_FILE = `${ROUTE_DASHBOARD_GAME_OVERVIEW_FILES}/new`
