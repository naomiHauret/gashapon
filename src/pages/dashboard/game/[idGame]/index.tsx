        ...
        <Portal>
          <DialogModal
            ...
            title={`Are you sure you want to unindex ${
              game()?.data?.publication?.metadata?.attributes.filter((attr) => attr.traitType === 'title')[0]?.value ?? 'this game'
            } ?`}
          ...
          >
            <Show when={!stateDeletePublication.isSuccess}>
              <div class="animate-appear">
                <p>
                  Unindexing a game is similar to deleting it: users won't be able to see it anymore. However, it will
                  still be visible on chain.
                </p>
            ...
            <Show when={stateDeletePublication.isSuccess}>
              <div class="animate-appear">
                <p class="font-semibold">
                  {game()?.data?.publication?.metadata?.attributes.filter((attr) => attr.traitType === 'title')[0]?.value ?? 'This game'} was
