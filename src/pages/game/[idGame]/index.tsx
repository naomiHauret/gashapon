              ...
              <div class="md:w-1/3 relative mb-6 md:mb-0">
                <div class="md:sticky md:top-6">
                  ...
                  <ul class="mt-4 text-xs space-y-1.5">
                    <Show
                      when={
                        game()?.data.publication?.metadata.attributes.filter((attr) => attr.traitType === 'website')[0]
                          ?.value
                      }
                    >
                      <li>
                    ...
                    <Show
                      when={
                        game()?.data.publication?.metadata.attributes.filter((attr) => attr.traitType === 'steamUrl')[0]
                          ?.value
                      }
                    >
                      <li>
                    ...
                    <Show
                      when={
                        game()?.data.publication?.metadata.attributes.filter((attr) => attr.traitType === 'itchUrl')[0]
                          ?.value
                      }
                    >
                      <li>
